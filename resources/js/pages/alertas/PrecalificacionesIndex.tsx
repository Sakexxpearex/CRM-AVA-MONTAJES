...
export default function PrecalificacionesIndex({ alertas }: { alertas: any[] }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Precalificaciones Estancadas - AVA" />

            <PageContainer>
                <PageHeader
                    title="Precalificaciones Estancadas"
                    subtitle="Precalificaciones sin interacción comercial por más de 15 días"
                    icon={OctagonAlert}
                />
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-gray-50 dark:bg-black/20 text-[9px] font-black uppercase text-gray-500 tracking-widest">
                                <tr>
                                    ...
                                    <th className="px-6 py-3">Precalificación</th>
                                ...
                                {alertas.length === 0 ? (
                                    <tr>
                                        <td colSpan={5} className="px-6 py-8 text-center text-gray-400 text-xs font-bold uppercase tracking-widest">
                                            ¡Felicidades! No hay precalificaciones estancadas.
                                        </td>
                                    </tr>
                                ) : (
                                    alertas.map((alerta) => (
